...
<h4 class="page-header"><i class="fa fa-users"></i> Data Pengguna Sistem</h4>
<div class="row">
                    <div class="col-lg-12">
...
<?php
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <a href="?get=edit_user&id=<?php echo $data['id_user']; ?>"<i class="icon fa fa-edit" title="Edit data"> Edit</i></a> || <a href="mod/user/process.php?act=delete_user&id=<?php echo $data['id_user']; ?>" onclick="return confirm ('Hapus Data User <?php echo $data['username']; ?> ?')"><i class="icon fa fa-trash" title="Hapus data"> Hapus</i></a>
            </td>
        </tr>
