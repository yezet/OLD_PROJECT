...
if($_SESSION['level']=='1'){
?>
<h3 class="page-header"><i class="fa fa-dashboard"> </i> Dashboard | Admin</h3>
<!-- /.row -->
    <div class="row">
...
?>
<h3 class="page-header"><i class="fa fa-dashboard"> </i> Dashboard | User</h3>
<!-- /.row -->
    <div class="row">
    <div class="col-lg-3 col-md-6">
    </div>
...
?>
<h3 class="page-header"><i class="fa fa-home"> </i> Sistem Informasi Persediaan Barang</h3>
